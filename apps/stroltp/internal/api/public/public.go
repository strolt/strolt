// Package public provides HTTP handlers that do not require authentication.
package public
...
// Public groups HTTP handlers available without authentication.
type Public struct{}
...
// Router registers public routes on the given router.
